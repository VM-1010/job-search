...
const jobValidation = [
  ...
  body("experienceLevel")
    ...
    .withMessage(
      "Experience level must be: Entry Level, Mid Level, Senior Level, Lead / Manager, or Executive",
    ),
...
const jobUpdateValidation = [
  ...
  body("requirements")
    .optional()
    .notEmpty()
    .withMessage("Job requirements cannot be empty"),
  body("responsibilities")
    .optional()
    .notEmpty()
    .withMessage("Job responsibilities cannot be empty"),
  body("skills")
    .optional()
    .isArray()
    .withMessage("Skills must be an array of strings"),
