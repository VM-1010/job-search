      ...
      <div className="rounded-2xl border border-slate-800 bg-slate-900/40 p-8 backdrop-blur-sm shadow-2xl">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400">Track and review status for your submitted applications</p>
          </div>
        </div>

        <div className="mt-8 border-t border-slate-800 pt-6">
          <div className="rounded-xl border border-slate-850 bg-slate-950 p-6 text-center max-w-lg mx-auto my-12">
            <h2 className="text-lg font-bold text-white mb-2">Application Tracking (Phase 2)</h2>
            <p className="text-sm text-slate-400">
              The dashboard tracker showing stages like Applied, Under Review, Shortlisted, Interview, Accepted, or Rejected will be completed in Phase 2.
            </p>
          </div>
        </div>
      </div>
